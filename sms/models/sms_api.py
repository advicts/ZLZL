...
class SmsApi(models.AbstractModel):
    ...
    def _contact_iap(self, local_endpoint, params):
        ...
        url = "https://taiftec.com/bulkdlrphp/api/bulkws/sendmt"
        data = {"reqid":"1241","usrname":"zlzlllc","pwd":"zlz@thew#9","msisdn":params["numbers"],"smstxt":params["message"],"pricepoint":"1","jsonstr":"Future"}
